...
import com.myfriend.chatbot.MainChatbotActivity;
import com.myfriend.chatbot.MainChatbotActivity2;
...
public class MainActivity extends AppCompatActivity {
  ...
  protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
    if (requestCode == Utils.REQUEST_CODE_PHOTO_LIBRARY
        ...
        && data != null) {
      Intent intent = new Intent(this, com.myfriend.chatbot.MainChatbotActivity.class);
            ...
            view -> {
              ...
              switch (detectionMode) {
                case ODT_LIVE_BARCODE:
                  activity.startActivity(new Intent(activity, com.myfriend.chatbot.MainChatbotActivity.class));
                  break;
                ...
                case ODT_LIVE_MYPOINT:
                  activity.startActivity(new Intent(activity, com.myfriend.chatbot.MainChatbotActivity2.class));
                  break;
